            ...
            <div className="flex flex-wrap items-center ">
              ...
              <div className="w-full shrink-0 grow-0 basis-auto md:px-6 lg:w-7/12">
                <div className="mb-12 flex">
                  ...
                  <div className="ml-4 grow">
                    ...
                    <p className="text-neutral-500 dark:text-neutral-300">
                      Nanoplastia is an innovative hair treatment that can help
                      to heal, repair, and restore damaged hair. It is a
                      formaldehyde-free treatment that uses a combination of
                      keratin and other nutrients to strengthen the hair shaft
                ...
                <div className="mb-12 flex">
                  ...
                  <div className="ml-4 grow">
                    <p className="mb-2 font-bold">
                      Trusted by Clients and Stylists
                    </p>
                    <p className="text-neutral-500 dark:text-neutral-300">
                      Nanoplastia is a trusted hair treatment that is used by
                      salons and stylists all over the world. It is a safe and
                      effective treatment that can be used on all hair types,
                      including damaged, frizzy, and curly hair.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex">
                  ...
                  <div className="ml-4 grow">
                    ...
                    <p className="text-neutral-500 dark:text-neutral-300">
                      Nanoplastia has been clinically tested and proven to be
                      safe and effective. It is a formaldehyde-free treatment
