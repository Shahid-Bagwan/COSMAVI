            ...
            <div className="hidden lg:flex lg:gap-x-12 pr-9">
              {navigation.map((item) => (
                <a
                  key={item.name}
                  href={item.href}
                  className="text-sm font-semibold leading-6 text-gray-700 hover:text-gray-800"
                >
                  {item.name}
                </a>
              ))}
          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-16">
            <div className="text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                Welcome to Cosmavi, where we believe every strand of hair tells
                a unique story, and your hair deserves the best, naturally.
              </p>
            </div>
          </div>
        </div>
